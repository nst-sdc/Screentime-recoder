...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-50 px-6 py-24 relative">
      ...
      <div className="w-full max-w-7xl h-[620px] grid grid-cols-1 md:grid-cols-2 gap-14 bg-white shadow-2xl rounded-2xl overflow-hidden border border-green-200">

        {/* Left Side: Login Form */}
        <div className="flex flex-col justify-center px-14 py-12">
          <h2 className="text-4xl font-bold text-green-700 mb-4">Welcome Back</h2>
        ...
        <div className="flex flex-col items-center justify-center bg-green-100 p-12 space-y-6">
          <img
            src=""
          ...
          <p className="text-green-700 text-center max-w-sm">
