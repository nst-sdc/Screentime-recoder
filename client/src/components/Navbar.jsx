...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* Left-side links */}
      <ul className="flex gap-8 list-none items-center relative z-20 overflow-x-auto whitespace-nowrap scrollbar-hide max-w-full px-1">
        ...
        <li className="flex items-center space-x-1">
          ...
          <Link
            to="/"
            className="relative px-4 py-2 rounded-full text-green-700 dark:text-green-400 text-base font-semibold tracking-wide hover:bg-green-100 dark:hover:bg-green-900 transition-colors duration-300 shadow-sm"
          >
            Home
          </Link>
        </li>
        {!isAuthenticated && (
          <>
            <li>
              <Link
                to="/login"
                className="relative px-4 py-2 rounded-lg text-green-900 dark:text-green-400 text-base font-semibold tracking-wide hover:text-green-700 dark:hover:text-green-300 transition-colors duration-300 hover:shadow-lg hover:bg-green-100 dark:hover:bg-green-900"
              >
                Login
              </Link>
            </li>
